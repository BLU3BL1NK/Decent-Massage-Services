...
<nav class="art-nav">
    <ul class="art-hmenu">
        <?php
            include 'Administrator/includes/Unregister/Services.html'
        ?>
    </ul> 
    </nav>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%" ><br>
        <center><font size=5><b>PACKAGES</b></font></center><br><br>
        <?php
            $limit_word = 250;
            $A = mysqli_query($cnn,"SELECT * FROM tblservices WHERE Category='Package'");
            ...
            <center><table width=90%>
                <tr>
                    <td width=50%>
                        <table width=100%>
                            <tr rowspan=2>
                                <td><img src='Administrator/Massage/<?php echo $A1[4]?>' style='width:95%;height:200px'></td>
                            </tr>
                        </table>
                    </td>
                     <td width=49% style='vertical-align:top'>
                        <table width=100%>
                            ...
                            <tr height=5px></tr>
                            <tr>
                                <td><a href='ViewPackage.php?No=<?php echo $A1[0]?>'><input type='button' class='art-button' value='VIEW MORE' style='width:90px'><a></td>
                            </tr>
                        </table>
                    </td>
                    <td width=2%></td>
