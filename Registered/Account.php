...
$A = mysqli_query($cnn,"SELECT * FROM tblclient WHERE ClientID='$ClientID'");
...
<nav class="art-nav">
    <ul class="art-hmenu">
        <?php
            include '../Administrator/includes/Register/Account.html'
        ?>
    </ul> 
    </nav>
    ...
    <div class="art-layout-cell" style="width: 100%;font-size:18px" >
        ...
        <form method='POST' action='../Administrator/connection/functions.php'>
            <center><table width=80%>
                    ...
                    <td width=40%>
                        <table width=100%>
                            <tr>
                                ...
                                <td width=55%><input type='text' value='<?php echo $A1[1]?>' name='FName' required='' onkeyup="leftTrim(this)" style='width:95%;background: #FFFFFF'></td>
                            </tr>
                            <tr height=10px></tr>
                            <tr>
                                <td width=15%>LASTNAME:</td>
                                <td width=55%><input type='text' value='<?php echo $A1[2]?>' name='LName' required='' onkeyup="leftTrim(this)" style='width:95%;background: #FFFFFF'></td>
                            </tr>
                            <tr height=10px></tr>
                            <tr>
                                <td width=15%>BIRTHDATE:</td>
                                <td width=55%><input type='date' name='BDate' required='' value='<?php echo $A1[3]?>'></td>
                            </tr>
                            <tr height=10px></tr>
                            <tr>
                                <td width=15%>AGE:</td>
                                <td width=55%><input type='text' name='Age' value='<?php echo $A1[4]?>' style='width:95%;background: #FFFFFF' required='' onkeyup="leftTrim(this)" onkeypress="return isNumberKey(event)"></td>
                            </tr>
                            <tr height=10px></tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width=55%><input type='email' name='EMail' value='<?php echo $A1[7]?>' required onkeyup="leftTrim(this)"></td>
                            </tr>
                        </table>
                    </td>
                    <td width=50%>
                        <table width=100%>
                            <tr>
                                ...
                                <td width=55%><input type='text' name='Address' value='<?php echo $A1[8]?>' required onkeyup="leftTrim(this)" style='width:95%;background: #FFFFFF'></td>
                            </tr>
                            <tr height=10px></tr>
                            <tr>
                                <td width=15%>MOBILE:</td>
                                <td width=55%><input type='text' name='CNo' value='<?php echo $A1[9]?>' required=''style='width:95%;background: #FFFFFF'  onkeyup="leftTrim(this)" onkeypress="return isNumberKey(event)"></td>
                            </tr>
                            <tr height=10px></tr>
                            <tr>
                                <td width=25%>USERNAME:</td>
                                <td width=55%><input type='text' name='User' value='<?php echo $A1[10]?>' required onkeyup="leftTrim(this)" style='width:95%;background: #FFFFFF'></td>
                            </tr>
                            <tr height=10px></tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width=55%><input type='password' name='NPass' required onkeyup="leftTrim(this)" style='width:95%;background: #FFFFFF'></td>
                            </tr>
                            <tr height=10px></tr>
                            <tr>
                                <td width=15%>CONFIRM PASSWORD:</td>
                                <td width=55%><input type='password' name='CPass' required onkeyup="leftTrim(this)" style='width:95%;background: #FFFFFF'></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr height=20px></tr>
                <tr>
                    <td colspan=2><center><input type='submit' class='art-button' name='ClientAccount' value='SAVE'>&nbsp;&nbsp;&nbsp;<a href='Account.php'><input type='button' class='art-button' value='CANCEL'></a></center></td>
                </tr>
            </table></center>
        </form>
            </div>
