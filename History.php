...
<nav class="art-nav">
    <ul class="art-hmenu">
        <?php
            include 'Administrator/includes/Unregister/AboutUs.html'
        ?>
    </ul> 
    </nav>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-4" style="width: 100%;font-weight:bold" >
       <font size=5><b>BRIEF HISTORY</b></font>
    </div>
    </div>
</div>
</div>
<div class="art-content-layout-br layout-item-1">
    ...
    <div class="art-layout-cell" style="width: 100%;font-size:18px" >
        <center><table width=100%>
                ...
                <tr height=5></tr>
                <tr>
                    <td colspan=2><hr color='#D4A017'></td>
                </tr>
                <tr height=5></tr>
                <tr>
                    <td colspan=2><font size=4>Decent Touch Massage Center has been proven for its quality performance and the satisfactions gained by the clients. This is a center of wellness that preserves its integrity  and passion to the people. It’s quite far from where it begins and is continuously rendering of its best to ease once pain.</font></td>
                </tr>
                <tr height=20></tr>
                <tr>
                    <td colspan=2><font size=4>Decent Touch Massage Center is not only offering services but also a part-time career towards skilled and aspirant applicants. We are located at San Jose Pajares Avenue, Pagadian City. For more query, please feel free to email us here: DTMC_2016@gmail.com.</font></td>
                </tr>
                <tr height=20></tr>
                <tr>
                    <td colspan=2><font size=4>This is owned by Mr. & Mrs. Edgar P. Decena.</font></td>
                </tr>
            </table></center>
            </div>
    </div>
