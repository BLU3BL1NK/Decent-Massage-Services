...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%" ><br>
        <center><font size=5><b>PROMO</b></font></center><br><br>
        <?php
            $limit_word = 250;
            $A = mysqli_query($cnn,"SELECT * FROM tblservices WHERE Category='Promo'");
                    ...
                    <td width=50%>
                     ...
                     <td width=49% style='vertical-align:top'>
                        <table width=100%>
                            ...
                            <tr height=5px></tr>
                            <tr>
                                <td><a href='ViewPromo.php?No=<?php echo $A1[0]?>'><input type='button' class='art-button' value='VIEW MORE' style='width:90px'><a></td>
                            </tr>
                        </table>
                    </td>
                    <td width=2%></td>
