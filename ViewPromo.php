...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%" ><br>
        <center><font size=5><b>VIEW PROMO</b></font></center><br>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell" style="width: 100%;font-size:18px" >
        <center><table width=90%>
            <tr>
                <td width=100% style='text-align:right'><a href='Promo.php'><input type='button' class='art-button' value='CANCEL'></a></td>
            </tr>
        </table></center>
            </div>
    </div>
