...
<nav class="art-nav">
    <ul class="art-hmenu">
        <?php
            include 'Administrator/includes/Unregister/News.html'
        ?>
    </ul> 
    </nav>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%" ><br>
        <center><font size=5><b>OUR THERAPIST</b></font></center><br><br>
        <center><table width=95% border=1>
                <tr>
                    <?php
                        $A = mysqli_query($cnn,"SELECT * FROM tbltherapist LIMIT 0,3");
                        while ($A1 = mysqli_fetch_array($A)) {
                            echo "<td width=30%><img src='Administrator/Therapist/" . $A1[1] . "' style='width:245px;height:250px'></td>";
                        }
                    ?>
                </tr>
                 <tr>
                    <?php
                        $A = mysqli_query($cnn,"SELECT * FROM tbltherapist LIMIT 0,3");
                        while ($A1 = mysqli_fetch_array($A)) {
                            echo "<td width=30%><font size=5><center>" . $A1[2] . "</center></font></td>";
                        }
                    ?>
                </tr>
                <tr height=10px></tr>
                <tr>
                    <?php
                        $A = mysqli_query($cnn,"SELECT * FROM tbltherapist LIMIT 3,3");
                        while ($A1 = mysqli_fetch_array($A)) {
                            echo "<td width=30%><img src='Administrator/Therapist/" . $A1[1] . "' style='width:240px;height:250px'></td>";
                        }
                    ?>
                </tr>
                <tr>
                ...
                <tr>
                    <?php
                        $A = mysqli_query($cnn,"SELECT * FROM tbltherapist LIMIT 6,3");
                        while ($A1 = mysqli_fetch_array($A)) {
                            echo "<td width=30%><img src='Administrator/Therapist/" . $A1[1] . "' style='width:240px;height:250px'></td>";
                        }
                    ?>
                ...
                <tr>
                    <?php
                        $A = mysqli_query($cnn,"SELECT * FROM tbltherapist LIMIT 9,3");
                        while ($A1 = mysqli_fetch_array($A)) {
                            echo "<td width=30%><img src='Administrator/Therapist/" . $A1[1] . "' style='width:240px;height:250px'></td>";
                        }
                    ?>
                ...
                <tr>
                    <?php
                        $A = mysqli_query($cnn,"SELECT * FROM tbltherapist LIMIT 12,3");
                        while ($A1 = mysqli_fetch_array($A)) {
                            echo "<td width=30%><img src='Administrator/Therapist/" . $A1[1] . "' style='width:240px;height:250px'></td>";
                        }
                    ?>
