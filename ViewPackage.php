...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%" ><br>
        <center><font size=5><b>VIEW PACKAGES</b></font></center><br>
        <center><table width=90%>
                <tr>
                    <td width=100% style='vertical-align:top'>
                        <table width=100%>
                            <tr rowspan=2>
                                <td><img src='Administrator/Massage/<?php echo $A1[4]?>' style='width:95%;height:300px'></td>
                            </tr>
                        </table>
                    </td>
                </tr>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell" style="width: 100%;font-size:18px" >
        <center><table width=90%>
            <tr>
                <td width=100% style='text-align:right'><a href='Packages.php'><input type='button' class='art-button' value='CANCEL'></a></td>
            </tr>
        </table></center>
            </div>
    </div>
