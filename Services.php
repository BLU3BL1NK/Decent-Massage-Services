...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%" ><br>
        <center><font size=5><b>SERVICES</b></font></center><br><br>
        <?php
            $limit_word = 250;
                    ...
                    <td width=50%>
                     ...
                     <td width=49% style='vertical-align:top'>
                        <table width=100%>
                            ...
                            <tr height=5px></tr>
                            <tr>
                                <td><a href='ViewServices.php?No=<?php echo $A1[0]?>'><input type='button' class='art-button' value='VIEW MORE' style='width:90px'><a></td>
                            </tr>
                        </table>
                    </td>
                    <td width=2%></td>
