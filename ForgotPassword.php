...
<div class="art-sheet clearfix">
        ...
        <div class="art-blockheader"><br><br><br>
            <center><font color='#000000' size=5>FORGOT PASSWORD</font></center></td><br>
        </div>
        <div class="art-blockcontent">
        <form method="post" action="Administrator/connection/functions.php" class="login">
            <p>
              <input type="email" name="ForgotPassword" required placeholder='Enter Email Address'>
            </p>
            <p>
              <center><input type="submit" class="art-button" value='SEND' name='Forgot'> <input type="button" class="art-button" value='Cancel' onclick='history.go(-1)'>
            </p>
          </form>
</div><br><br>
