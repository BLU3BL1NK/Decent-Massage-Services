...
$No = $_GET['No'];
$A = mysqli_query($cnn,"SELECT * FROM tblnews WHERE No='$No'");
    ...
    <div class="art-layout-cell" style="width: 100%;font-size:18px" >
        <center><font size=5><b>NEWS</b></font><br><br>
            ...
            <center><table width=50%>
                <tr>
                    <td width=50%><textarea name='News' required='' style='resize:none' onkeyup="leftTrim(this)" rows=15><?php echo $A1[1]?></textarea></td>
                </tr>
                    <tr height=50px><input type='hidden' name='No' value='<?php echo $A1[0]?>'></tr>
                    <tr>
                        <td width=100% colspan=2><center><input type='submit' class='art-button' name='EditNews' value='SAVE'>&nbsp;&nbsp;<a href='User.php'><input type='button' class='art-button' value='CANCEL'></a></td>
                    </tr>
                    <tr height=20px></tr>
                </tr>
            </table></center>
