...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell" style="width: 100%;font-size:18px" >
        <center><font size=5><b>THERAPIST</b></font><br><br>
            
            <center><table width=100%>
                <tr>
                    <?php
                        $A = mysqli_query($cnn,"SELECT * FROM tbltherapist LIMIT 0,4");
                        while ($A1 = mysqli_fetch_array($A)) {
                            echo "<td width=25%><img src='Therapist/" . $A1[1] . "' style='width:300px;height:300px'></td>";
                        }
                    ?>
                </tr>
                 <tr>
                    <?php
                        $A = mysqli_query($cnn,"SELECT * FROM tbltherapist LIMIT 0,4");
                        while ($A1 = mysqli_fetch_array($A)) {
                            echo "<td width=25%><font size=5><center>" . $A1[2] . "</center></font></td>";
                        }
                    ?>
                </tr>
                <tr>
                    <?php
                        $A = mysqli_query($cnn,"SELECT * FROM tbltherapist LIMIT 0,4");
                        while ($A1 = mysqli_fetch_array($A)) {
                            echo "<td width=25%><font size=5><center><a href='EditTherapist.php?No=" . $A1[0] . "'><input type='button' class='art-button' value='EDIT'></a> <a href='DeleteTherapist.php?No=" . $A1[0] . "'><input type='button' class='art-button' value='DELETE'></a></center></font></td>";
                        }
                    ?>
                </tr>
                <tr height=10px></tr>
                <tr>
                    <?php
                        $A = mysqli_query($cnn,"SELECT * FROM tbltherapist LIMIT 4,4");
                        while ($A1 = mysqli_fetch_array($A)) {
                            echo "<td width=25%><img src='Therapist/" . $A1[1] . "' style='width:300px;height:300px'></td>";
                        }
                    ?>
                ...
                <tr>
                    <?php
                        $A = mysqli_query($cnn,"SELECT * FROM tbltherapist LIMIT 8,4");
                        while ($A1 = mysqli_fetch_array($A)) {
                            echo "<td width=25%><img src='Therapist/" . $A1[1] . "' style='width:300px;height:300px'></td>";
                        }
                    ?>
                ...
                <tr>
                    <?php
                        $A = mysqli_query($cnn,"SELECT * FROM tbltherapist LIMIT 12,4");
                        while ($A1 = mysqli_fetch_array($A)) {
                            echo "<td width=25%><img src='Therapist/" . $A1[1] . "' style='width:300px;height:300px'></td>";
                        }
                    ?>
                ...
                <tr height=20px></tr>
                <tr>
                    <td><a href='AddTherapist.php'><input type='button' class='art-button' value='ADD THERAPIST' style='width:120px;height:40px'><a></td>
                </tr>
            </table></center>
            </div>
    </div>
