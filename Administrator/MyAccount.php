...
<nav class="art-nav">
    <ul class="art-hmenu">
        <?php
            include 'includes/Admin/MyAccount.html'
        ?>
    </ul> 
    </nav>
    ...
    <div class="art-layout-cell" style="width: 100%;font-size:18px" >
        ...
        <form method='POST' action='connection/functions.php' name="FORM1" enctype="multipart/form-data">
            <center><table width=40%>
                ...
                <tr height=50px></tr>
                <tr>
                    <td width=100% colspan=2><center><input type='submit' class='art-button' name='MyAccount' value='UPDATE'>&nbsp;&nbsp;<a href='User.php'><input type='button' class='art-button' value='CANCEL'></a></td>
                </tr>
            </table></center>
        </form>
            </div>
