...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%" >
        <center><font size=5><b>PROMOS</b></font></center>
    </div>
    </div>
</div>
</div>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-4" style="width: 100%;font-weight:bold" >
       <?php
            $limit_word = 400;
            $A = mysqli_query($cnn,"SELECT * FROM tblservices WHERE Category='Packages'");
        ...
        ?>
            <center><table width=90%>
                <tr height=20px></tr>
                <tr>
                    <td><a href='AddPromo.php'><input type='button' class='art-button' value='ADD PROMO' style='width:120px;height:40px'><a></td>
                </tr>
            </table></center>
    </div>
    </div>
