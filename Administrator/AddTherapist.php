...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%" >
        <center><font size=5><b>ADD NEW THERAPIST</b></font></center>
    </div>
    </div>
</div>
</div>
    ...
    <div class="art-layout-cell layout-item-4" style="width: 100%;font-weight:bold" >
       <form method='POST' action='connection/functions.php' name="FORM1" enctype="multipart/form-data">
            <center><table width=40%>
                ...
                <tr height=50px></tr>
                <tr>
                    <td width=100% colspan=2><center><input type='submit' class='art-button' name='AddTherapist' value='SAVE'>&nbsp;&nbsp;<a href='Therapist.php'><input type='button' class='art-button' value='CANCEL'></a></td>
                </tr>
            </table></center>
        </form>
    </div>
