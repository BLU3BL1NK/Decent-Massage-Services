...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%" >
        <center><font size=5><b>ADD NEW PACKAGES</b></font></center>
    </div>
    </div>
</div>
</div>
    ...
    <div class="art-layout-cell layout-item-4" style="width: 100%;font-weight:bold" >
       <form method='POST' action='connection/functions.php' name="FORM1" enctype="multipart/form-data">
            <center><table width=40%>
                <tr>
                    <td width=25%>Promo Name:</td>
                    <td width=75%><input type='text' name='SName' required='' onkeyup="leftTrim(this)"></td>
                </tr>
                <tr height=5px></tr>
                <tr>
                    <td width=25%>Price:</td>
                    <td width=75%><input type='text' name='Price' required='' onkeyup="leftTrim(this)" onkeypress="return isNumberKey(event)"></td>
                </tr>
                <tr height=5px></tr>
                <tr>
                    <td width=25%>Duration(Hour):</td>
                    <td width=75%><input type='text' name='Duration' required='' onkeyup="leftTrim(this)" onkeypress="return isNumberKey(event)"></td>
                </tr>
                <tr height=5px></tr>
                <tr>
                    <td width=25% style='vertical-align: top;'>Description:</td>
                    <td width=75%><textarea name='Desc' required='' style='resize:none' onkeyup="leftTrim(this)" rows=15></textarea></td>
                </tr>
                <tr height=5px></tr>
                <tr>
                    <td width=25%>Image:</td>
                    <td width=75%><input type='file' name='Pix' required=''></td>
                </tr>
                <tr height=50px></tr>
                <tr>
                    <td width=100% colspan=2><center><input type='submit' class='art-button' name='AddPackage' value='SAVE'>&nbsp;&nbsp;<a href='Packages.php'><input type='button' class='art-button' value='CANCEL'></a></td>
                </tr>
            </table></center>
        </form>
    </div>
