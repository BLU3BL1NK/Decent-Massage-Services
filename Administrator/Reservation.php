...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell" style="width: 100%;font-size:18px" >
        <center><font size=5><b>LIST OF RESERVATIONS</b></font><br><br>
        <center><table width=100% border=1 cellspacing=0>
                <tr bgcolor='#C6DEFF'>
                    <td width=10%><center><b>RESERVATION ID</b></center></td>
                    <td width=20%><center><b>CLIENT NAME</b></center></td>
                    <td width=5%><center><b>AGE</b></center></td>
                    <td width=5%><center><b>GENDER</b></center></td>
                    ...
                    <td width=5% colspan=3><center><b>OPTION</b></center></td>
                </tr>
                <?php
                    $B = 1;
                    $A1 = mysqli_query($cnn,"SELECT tblreservation.ReservationID,tblclient.FName,tblclient.LName,tblclient.Age,tblclient.Sex,tblclient.Mobile,tblservices.Type,tblreservation.Date,tblreservation.FTime,tblreservation.Type,tblreservation.`Status` FROM tblreservation INNER JOIN tblclient ON tblreservation.ClientID = tblclient.ClientID INNER JOIN tblservices ON tblreservation.ServiceID = tblservices.`No` WHERE tblreservation.Status='Pending' ORDER BY tblreservation.Date desc");
                    while ($A2 = mysqli_fetch_array($A1)) {
                        if($B % 2 == 1)
                            ...
                            echo "<td>" . $A2[9] . "</td>";
                            echo "<td>" . $A2[10] . "</td>";
                            echo "<td><center><a href='SendSMS.php?ReservationID=" . $A2[0] . "'><img src='images/send_sms.png' style='width:25px;height:25px' title='SEND SMS'></a></td>";
                            echo "<td><center><a href='ConfirmReservation.php?ReservationID=" . $A2[0] . "'><img src='images/Confirm1.png' style='width:25px;height:25px' title='CONFIRM'></a></td>";
                            echo "<td><center><a href='CancelReservation.php?ReservationID=" . $A2[0] . "'><img src='images/Cancel1.png' style='width:25px;height:25px' title='CANCEL'></a></td>";
                            $B++;
                        }
                ?>
            </table></center>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-0" style="width: 50%">
        ...
        <p style="text-align: right;">Copyright © 2025 <a href="#">Privacy Policy</a><br>
