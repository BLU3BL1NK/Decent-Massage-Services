...
<nav class="art-nav">
    <ul class="art-hmenu">
        <?php
            include 'includes/Admin/Payment.html'
        ?>
    </ul> 
    </nav>
    ...
    <div class="art-layout-cell" style="width: 100%;font-size:18px" >
        ...
        <center><table width=100% border=1 cellspacing=0>
                <tr bgcolor='#C6DEFF'>
                    ...
                    <td width=5%><center><b>PAY</b></center></td>
                </tr>
                <?php
                    $B = 1;
                    ...
                    while ($A2 = mysqli_fetch_array($A1)) {
                        if($B % 2 == 1)
                            ...
                            echo "<td>" . $A2[9] . "</td>";
                            echo "<td>Ongoing</td>";
                            echo "<td><center><a href='Paid.php?ReservationID=" . $A2[0] . "'><img src='images/Payment.png' style='width:25px;height:25px' title='CONFIRM'></a></td>";
                            $B++;
                        }
                ?>
            </table></center>
