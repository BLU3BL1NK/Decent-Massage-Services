...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%" >
        <center><font size=5><b>PACKAGES</b></font></center>
        <br>
    </div>
    </div>
</div>
       ...
       <?php
        ...
        ?>
            <center><table width=90%>
                <tr height=20px></tr>
                <tr>
                    <td><a href='AddPackages.php'><input type='button' class='art-button' value='ADD PACKAGES' style='width:120px;height:40px'><a></td>
                </tr>
            </table></center>
    </div>
    </div>
