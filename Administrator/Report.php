...
<nav class="art-nav">
    <ul class="art-hmenu">
        <?php
            include 'includes/Admin/Report.html'
        ?>
    </ul> 
    </nav>
...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell" style="width: 100%;font-size:18px" >
        <center><font size=5><b>INCOME REPORT</b></font><br><br><br>
        <center><table width=70% border=1 cellspacing=0>
                <tr bgcolor='#C6DEFF'>
                    <td width=20%><center><b>SERVICE NAME</b></center></td>
                    <td width=25%><center><b>RECEIVED BY</b></center></td>
                    <td width=30%><center><b>DATE</b></center></td>
                    <td width=10%><center><b>AMOUNT</b></center></td>
                </tr>
                <?php
                    $B = 1;
                    $Total = 0;
                    $A1 = mysqli_query($cnn,"SELECT * from tblreport");
                    while ($A2 = mysqli_fetch_array($A1)) {
                        if($B % 2 == 1)
                            ...
                            echo "<td>" . $A2[2] . "</td>";
                            echo "<td>" . $A2[4] . "</td>";
                            echo "<td>" . date('F d, Y',strtotime($A2[1])) . "</td>";
                            echo "<td>" . number_format($A2[3],2) . "</td>";
                            $Total = $Total + $A2[3];
                            $B++;
                        }
                ?>
            ...
            <center><table width=70%>
                ...
                <tr>
                    ...
                    <td width=30% style='text-align:right'><b>TOTAL: </b></center></td>
                    <td width=10%><center><b><?php echo number_format($Total,2)?></b></center></td>
                </tr>
                <tr height=20px></tr>
                 <tr height=10px>
                    <td width=100% colspan=4><p align='right'><a href="javascript:window.print()"><input type='button' class='art-button' value='PRINT'></a></p></td>
                 </tr>
            </table></center>
            </div>
    </div>
...
<div class = "divcheckbox">
    ...
    <p><center><b><font size=5>INCOME REPORT</font></b></center></p>
<center><table width=70% border=1 cellspacing=0>
                <tr bgcolor='#C6DEFF'>
                    <td width=20%><center><b>SERVICE NAME</b></center></td>
                    <td width=25%><center><b>RECEIVED BY</b></center></td>
