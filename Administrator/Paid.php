...
<div class="art-content-layout">
    ...
    <div class="art-layout-cell" style="width: 100%;font-size:18px" >
        ...
        <center><table width=30%>
                ...
                <tr height=20px></tr>
                <tr>
                    <td colspan=2><center><input type='submit' class='art-button' name='AmountPaid' value='PRINT'></a>&nbsp;&nbsp;&nbsp;<a href='Payment.php'><input type='button' onclick='history.go(-1)' class='art-button' value='CANCEL'></a></center></td>
                </tr>
            </table></center>
        </form>
            </div>
